        ...
        <div class="col-md-12">
          <div class="tile">
                <div class="tile-title-w-btn">
                    ...
                    <p><a class="btn btn-warning icon-btn" href="evaluacion.php?curso=<?=$data['pm_id']; ?>&contenido=<?= $data['contenido_id']; ?>"><i class="fa fa-edit"></i>Ver Evaluacion</a></p>
                </div>
                <div class="tile-body">
                ...
                <div class="title-footer-mt4">
                        <div class="input-group">
                            ...
                            <a class="btn btn-primary" href="BASE_URL<?= $data['material_alumno']; ?>" target="_blank">Material de Descarga</a>
                        </div>
                    </div>
                </div>
          </div>
